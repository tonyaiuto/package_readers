...
from lib.saved_tree import SavedTreeReader
...
class TarReaderTest(unittest.TestCase):
    ...
    def test_tar_gz_reader_loads_reference(self):
        ...
        tar_path = get_runfile("testdata/reference_tar_gz.tar.gz")
        reader = TarReader(tar_path=tar_path)
        tree = load_tree_as_dict(reader)
    ...
    def test_tar_xz_reader_loads_reference(self):
        ...
        tar_path = get_runfile("testdata/reference_tar_xz.tar.xz")
        reader = TarReader(tar_path=tar_path)
        tree = load_tree_as_dict(reader)
    ...
    def test_tar_formats_produce_same_content(self):
        ...
        tar_path = get_runfile("testdata/reference_tar.tar")
        gz_path = get_runfile("testdata/reference_tar_gz.tar.gz")
        xz_path = get_runfile("testdata/reference_tar_xz.tar.xz")
...
class DebReaderTest(unittest.TestCase):
    ...
    def test_deb_reader_loads_package(self):
        ...
        deb_path = get_runfile("testdata/test_deb.deb")
