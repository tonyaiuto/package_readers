...
from lib.tar_reader import TarReader
...
class StreamCompareTest(unittest.TestCase):
    ...
    def test_stream_compare_identical(self):
        ...
        tar_path = get_runfile("testdata/reference_tar.tar")
    ...
    def test_stream_compare_missing_files(self):
        ...
        ref_path = get_runfile("testdata/reference_tar.tar")
        mod_path = get_runfile("testdata/modified_tar.tar")
    ...
    def test_stream_compare_extra_files(self):
        ...
        ref_path = get_runfile("testdata/reference_tar.tar")
        extra_path = get_runfile("testdata/extra_file_tar.tar")
    ...
    def test_stream_compare_mode_change(self):
        ...
        ref_path = get_runfile("testdata/reference_tar.tar")
        diff_path = get_runfile("testdata/different_mode_tar.tar")
    ...
    def test_stream_compare_uid_gid_change(self):
        ...
        ref_path = get_runfile("testdata/reference_tar.tar")
        diff_path = get_runfile("testdata/different_owner_tar.tar")
    ...
    def test_stream_compare_symlink_target_change(self):
        ...
        ref_path = get_runfile("testdata/reference_tar.tar")
        diff_path = get_runfile("testdata/different_symlink_tar.tar")
